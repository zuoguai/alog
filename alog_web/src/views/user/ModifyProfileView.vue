        ...
        <div class="row" style="padding-top: 5vh;">
            ...
            <div class="col-7">
                <div>
                    ...
                    <!-- 头像 -->
                    <div class="mb-3 row">
                        <label for="formFile" class="col-sm-2 col-form-label"><kbd>头像</kbd></label>
                        <div class="col-sm-8">
                    ...
                    <!-- 背景 -->
                    <div class="mb-3 row">
                        <label for="formFile" class="col-sm-2 col-form-label"><kbd>全局背景</kbd></label>
                        <div class="col-sm-8">
                            <input class="form-control" type="file"
                    ...
                    <!-- 用户名 -->
                    <div class="mb-3 row">
                        <label for="inputUsername" class="col-sm-2 col-form-label"><kbd>用户名</kbd></label>
                        <div class="col-sm-8">
                            <input type="text" v-model="username" class="form-control"
                                :placeholder="$store.state.user.username" id="inputUsername">
                        </div>
                        <div class="col-sm-2">
                    ...
                    <!-- 密码 -->
                    <div class="mb-3 row">
                        <label for="inputPassword1" class="col-sm-2 col-form-label"><kbd>密码</kbd></label>
                        <div class="col-sm-8">
                    ...
                    <!-- 重复密码 -->
                    <div class="mb-3 row">
                        <label for="inputPassword2" class="col-sm-2 col-form-label"><kbd>重复密码</kbd></label>
                        <div class="col-sm-8">
                    ...
                    <!-- 个性签名 -->
                    <div class="mb-3 row">
                        <label for="exampleFormControlTextarea1" class="col-sm-2 col-form-label"><kbd>个人简介</kbd></label>
                        <div class="col-sm-8">
                            <textarea v-model="proverb" class="form-control" :placeholder="$store.state.user.proverb"
    ...
    <div v-else style="padding: 1vw;">
        ...
        <div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-9">
                    <input type="text" v-model="username" class="form-control" :placeholder="$store.state.user.username"
                        id="inputUsername">
                </div>
                <div class="col-3">
                    <div v-if="isLoadingUsername" class="spinner-border text-primary col-sm-2" role="status">
