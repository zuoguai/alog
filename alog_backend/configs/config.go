...
// JwtConf jwt配置
type JwtConf struct {
	Expire int64  `yaml:"expire_time" mapstructure:"expire"` // jwt过期时间
	Secret string `yaml:"secret" mapstructure:"secret"`      // jwt加密密钥
	Issuer string `yaml:"issuer" mapstructure:"issuer"`      // jwt签发者
}
...
type GlobalConfig struct {
	...
	JwtConfig JwtConf `yaml:"jwt" mapstructure:"jwt"` // jwt配置
}
