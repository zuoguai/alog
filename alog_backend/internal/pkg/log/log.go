...
func DebugContextf(ctx context.Context, format string, args ...interface{}) {
	value := ctx.Value(pkg.ReqID)
	args = append([]interface{}{value}, args...)
	getDefaultLogger().Debugf(pkg.ReqID+":%s|"+format, args...)
}
...
func InfoContextf(ctx context.Context, format string, args ...interface{}) {
	value := ctx.Value(pkg.ReqID)
	args = append([]interface{}{value}, args...)
	getDefaultLogger().Infof(pkg.ReqID+":%s|"+format, args...)
}
...
func WarnContextf(ctx context.Context, format string, args ...interface{}) {
	value := ctx.Value(pkg.ReqID)
	args = append([]interface{}{value}, args...)
	getDefaultLogger().Warnf(pkg.ReqID+":%s|"+format, args...)
}

func ErrorContextf(ctx context.Context, format string, args ...interface{}) {
	value := ctx.Value(pkg.ReqID)
	args = append([]interface{}{value}, args...)
	getDefaultLogger().Errorf(pkg.ReqID+":%s|"+format, args...)
}
